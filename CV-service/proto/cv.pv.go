...
func (x *CVResponse) GetFirstName() string {
	if x != nil {
		return x.FirstName
	}
	return ""
...
func (x *CVResponse) GetLastName() string {
	if x != nil {
		return x.LastName
	}
	return ""
...
func (x *CVResponse) GetProfession() string {
	if x != nil {
		return x.City
	}
	return ""
...
func (x *CVResponse) GetExperience() int32 {
	if x != nil {
		return x.Experience
	}
	return 0
...
func (x *CVResponse) GetSkills() []string {
	if x != nil {
		return x.Skills
	}
	return nil
...
type GetAllResponse struct {
	...
	Cvs []*CVResponse `protobuf:"bytes,1,rep,name=cvs,proto3" json:"cvs,omitempty"`
}
...
func (x *GetAllResponse) GetCvs() []*CVResponse {
	if x != nil {
		return x.Cvs
	}
	return nil
...
var file_proto_cv_proto_rawDesc = []byte{
	...
	0x22, 0x9e, 0x01, 0x0a, 0x0a, 0x43, 0x56, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	...
	0x66, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x70,
	0x72, 0x6f, 0x66, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x1e, 0x0a, 0x0a, 0x65, 0x78, 0x70,
	...
	0x73, 0x74, 0x22, 0x2f, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x41, 0x6c, 0x6c, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1d, 0x0a, 0x03, 0x63, 0x76, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x0b, 0x2e, 0x43, 0x56, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x03,
	0x63, 0x76, 0x73, 0x32, 0x36, 0x0a, 0x09, 0x43, 0x56, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x12, 0x29, 0x0a, 0x06, 0x47, 0x65, 0x74, 0x41, 0x6c, 0x6c, 0x12, 0x0e, 0x2e, 0x47, 0x65, 0x74,
	0x41, 0x6c, 0x6c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0f, 0x2e, 0x47, 0x65, 0x74,
	0x41, 0x6c, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x09, 0x5a, 0x07, 0x2e,
...
var file_proto_cv_proto_goTypes = []interface{}{
	(*CVResponse)(nil),     // 0: CVResponse
	(*GetAllRequest)(nil),  // 1: GetAllRequest
	(*GetAllResponse)(nil), // 2: GetAllResponse
}
var file_proto_cv_proto_depIdxs = []int32{
	0, // 0: GetAllResponse.cvs:type_name -> CVResponse
	1, // 1: CVService.GetAll:input_type -> GetAllRequest
	2, // 2: CVService.GetAll:output_type -> GetAllResponse
